<?php
echo $this->Html->script(array('base64','DCMSCommon','DCMSMessage','DCMSWPO020_RELOAD'), array('inline'=>false));
...
<div class="box" style="width:1130px;">
	<?php echo $this->Form->create('WPO020Model', array('url' => '/WPO020','type'=>'get', 'inputDefaults' => array('label' => false,'div' => false))) ?>
		<table class="cndt">
			<tr>

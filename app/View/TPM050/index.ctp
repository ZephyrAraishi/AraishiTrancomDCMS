...
<?php  foreach ($lsts as $array): ?>
	<div class="tableRow row_dat" style="width:1420px;">
		...
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['KADO_NINZU'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['RUIKEI_NINZU'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['JIKAN_H'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['JIKAN_M'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['BUTURYO'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['SEISANSEI_JINJI'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['YOSOKU_BUTURYO'] ?></div>
		<div class="tableCell cell_dat" style="width:100px;" ><?php echo $array['YOSOKU_JIKAN'] ?></div>

		<div class="hiddenData"><?php echo $array['BNRI_DAI_CD'] ?></div>
		<div class="hiddenData"><?php echo $array['BNRI_CYU_CD'] ?></div>
		<div class="hiddenData"><?php echo $array['BNRI_SAI_CD'] ?></div>

<?php
			echo $this->Html->script(array('effects','window','protocalendar','base64',
					'DCMSMessage','DCMSCommon','DCMSValidation','DCMSTPM060_RELOAD', 'DCMSTPM060_CALENDAR',
					 'DCMSTPM060_BUNRUI','DCMSTPM060_CSV'), array('inline'=>false));
...
<div class="box" style="width:850px;">
	<?php echo $this->Form->create('TPM060Model', array('url' => '/TPM060','type'=>'get', 'inputDefaults' => array('label' => false,'div' => false))) ?>

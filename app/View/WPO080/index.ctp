<?php
            echo $this->Html->script(array('scriptaculous','window','base64','DCMSCommon','DCMSMessage','DCMSWPO080_UPDATE'), array('inline'=>false));
            echo $this->Html->script(array('scriptaculous','window','base64','DCMSCommon','DCMSMessage','DCMSWPO080_IMPORT','DCMSWPO080_CSV'), array('inline'=>false));

...
<div class="resizable_s" id="lstTable">
	<div class="tableRowTitle row_ttl_2" style="width:1235px;">
		<div class="tableCellBango cell_ttl_2_1" style="width:50px;" ><?php echo Configure::read('Bango'); ?></div>
...
<?php foreach ($lsts as $array): ?>
	<div class="tableRow row_dat" style="width:1235px;">
			<div class="tableCellBango cell_dat" style="width:50px;"><?php echo ($count + 1) + $index; ?></div>
			<div class="tableCell cell_dat nm" style="width:140px;"><?php echo $array['BNRI_DAI_RYAKU'] ?></div>
			<div class="tableCell cell_dat cd" style="width:90px;"><?php echo $array['BNRI_CYU_CD'] ?></div>
			<div class="tableCell cell_dat nm" style="width:240px;"><?php echo $array['BNRI_CYU_NM'] ?></div>
			<div class="tableCell cell_dat nm" style="width:140px;"><?php echo $array['BNRI_CYU_RYAKU'] ?></div>
			<div class="tableCell cell_dat nm" style="width:320px;"><?php echo $array['BNRI_CYU_EXP'] ?></div>
 			<div class="tableCell cell_dat kbn" style="width:75px;"><?php echo empty($array['KBN_TANI']) ? "" : $kbnTanis[$array['KBN_TANI']]; ?></div>
 			<div class="tableCell cell_dat kbn" style="width:40px;"><?php echo empty($array['KBN_URIAGE']) ? "" : $kbnUriages[$array['KBN_URIAGE']]; ?></div>
			<div class="tableCell cell_dat kbn" style="width:50px;"><?php echo $array['BNRI_CYU_CD_CNT'] ?></div>

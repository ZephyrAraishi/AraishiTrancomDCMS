...
InputCalendar.createOnLoaded('dailyPeriodFrom', {lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymmdd'});
InputCalendar.createOnLoaded('dailyPeriodTo', {lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymmdd'});
InputMonthCalendar.createOnLoaded('monthlyPeriodFrom', {lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymm'});
InputMonthCalendar.createOnLoaded('monthlyPeriodTo', {lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymm'});
</script>

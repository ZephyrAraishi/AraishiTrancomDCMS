...
<div id="wrapper_s">
	...
	<div style="position:relative;height:270px;margin-top:20px;text-align:left;">
		...
		<div style="position:absolute;height:25px;top:00px;left:200px;width:140px;" id="staff_cd"><?php echo $data->STAFF_CD ?></div>
...
?>
	...
	<div style="position:relative;margin-top:30px;margin-left:40px;">
		...
		<div class="tableRow" style="height:32px;width:709px;margin-left:1px;">
	...
	<div style="position:relative;height:50px;margin-left:40px;margin-top:20px;" >
		<div style="position:absolute;height:30px;top:0px;left:0px;width:200px;margin-top:2px;text-align:left;">
			<select id="del_flg" name="del_flg">
				<option value="0" <?php if($data->DEL_FLG == "" || $data->DEL_FLG == "0") echo "selected" ?>>このスタッフコードはシステム使用可能</option>
				<option value="1" <?php if($data->DEL_FLG == "1") echo "selected" ?>>このスタッフコードはシステム使用不可</option>
			</select>
		</div>

...
<!-- 検索 -->
<div class="box" style="width:1100px; height:170px">
...
<div class="resizable_s" id="lstTable">
	...
	?>
		<div class="tableRow row_dat" style="width:1575px;">
			...
			<div class="tableCell cell_dat nm" style="width:100px;"><?php echo $cellsArray[0] ?></div>
			<div class="tableCell cell_dat nm" style="width:100px;"><?php echo $cellsArray[1] ?></div>
			<div class="tableCell cell_dat cd" style="width:50px;"><?php echo $cellsArray[2] ?></div>
			<div class="tableCell cell_dat nm" style="width:200px;"><?php echo $cellsArray[3] ?></div>
			<div class="tableCell cell_dat nm" style="width:100px;"><?php echo $cellsArray[4] ?></div>
			<div class="tableCell cell_dat nm" style="width:205px;"><?php echo $cellsArray[5] ?></div>
			<div class="tableCell cell_dat kbn" style="width:80px;"><?php echo $cellsArray[6] ?></div>
 			<div class="tableCell cell_dat kbn" style="width:100px;"><?php echo $cellsArray[7] ?></div>
			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[8] ?></div>
 			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[9] ?></div>
			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[10] ?></div>
			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[11] ?></div>
 			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[12] ?></div>
			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[13] ?></div>
			<div class="tableCell cell_dat kbn" style="width:60px;"><?php echo $cellsArray[14] ?></div>
			...
			<div class="hiddenData KBN_TANI"><?php echo $dataArray[4] ?></div>
			<div class="hiddenData KBN_KTD_MKTK"><?php echo $dataArray[5] ?></div>
			<div class="hiddenData KBN_HISSU_WK"><?php echo $dataArray[6] ?></div>
			<div class="hiddenData KBN_GYOMU"><?php echo $dataArray[7] ?></div>
			<div class="hiddenData KBN_GET_DATA"><?php echo $dataArray[8] ?></div>
			<div class="hiddenData KBN_FUKAKACHI"><?php echo $dataArray[9] ?></div>
			<div class="hiddenData KBN_SENMON"><?php echo $dataArray[10] ?></div>
			<div class="hiddenData KBN_KTD_TYPE"><?php echo $dataArray[11] ?></div>
			<div class="hiddenData KEIYAKU_BUTURYO_FLG"><?php echo $dataArray[12] ?></div>
			<div class="hiddenData BUTTON_SEQ"><?php echo $dataArray[13] ?></div>
			<div class="hiddenData LIST_SEQ"><?php echo $dataArray[14] ?></div>
			<div class="hiddenData SYURYO_NASI_FLG"><?php echo $dataArray[12] ?></div>
			<div class="hiddenData KYORI_FLG"><?php echo $dataArray[16] ?></div>
		</div>
	<?php
		}
	}

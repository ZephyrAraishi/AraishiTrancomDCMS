<?php
echo $this->Html->script(array('base64','DCMSCommon','DCMSMessage','DCMSWPO023_RELOAD'), array('inline'=>false));
...
<div id="toggle">
		<ul class="toggle-list">
			...
			<li><a><label id="koshinButton"  style="width:100px;text-align:center" >更新</label></a></li>
		</ul>
...
<div class="box" style="width:1130px;">
	<?php echo $this->Form->create('WPO023Model', array('url' => '/WPO023','type'=>'get', 'inputDefaults' => array('label' => false,'div' => false))) ?>
		<table class="cndt">
			<tr>
...
<?php foreach ($lsts as $key => $value): ?>
	<div class="tableRow row_dat" style="width:1545px;">
			...
			<div class="tableCell cell_dat kbn" style="width:110px;"><?php 
			
				echo "<a href='/DCMS/WPO022?ymd_syori=" . $value['YMD_SYORI'] .
	                                           "&s_batch_no_cd=" . $value['S_BATCH_NO_CD'] .
	                                           "&s_kanri_no=" . $value['S_KANRI_NO'] .
	                                           "' target='_blank'> " . $value['S_KANRI_NO'] . "</a>";

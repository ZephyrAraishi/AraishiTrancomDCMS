<?php
echo $this->Html->script(array('effects','window','base64','DCMSMessage','DCMSCommon','DCMSWPO023_RELOAD','DCMSWPO023_POPUP','DCMSWPO023_UPDATE'), array('inline'=>false));
...
<div class="box" style="width:1130px;">
	<?php echo $this->Form->create('WPO023Model', array('url' => '/WPO023/update','type'=>'get', 'inputDefaults' => array('label' => false,'div' => false))) ?>
		<table class="cndt">
			<tr>
...
<?php foreach ($lsts as $key => $value): ?>
	<div class="tableRow row_dat" style="width:1545px;">
			...
			<div class="tableCell cell_dat kbn" style="width:90px;"><?php echo $value['KBN_STATUS_NM'] ?></div>

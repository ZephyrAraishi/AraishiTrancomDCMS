...
<?php foreach ($lsts as $array): ?>
	<div class="tableRow row_dat" style="width:1230px;">
		...
		<div class="tableCell cell_dat cd" style="width:100px;"><?php echo $array['STAFF_CD'] ?></div>
		<div class="tableCell cell_dat nm" style="width:300px;"><?php echo $array['STAFF_NM'] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $array['SUB_SYSTEM_ID'] ?></div>
		<div class="tableCell cell_dat nm" style="width:415px;"><?php echo $array['KINO_ID'] ?></div>

		<div class="hiddenData LINE_COUNT"><?php echo $count ?></div>
		<div class="hiddenData CHANGED">0</div>
		<div class="hiddenData STAFF_CD"><?php echo $array['STAFF_CD'] ?></div>
		<div class="hiddenData SUB_SYSTEM_ID"><?php echo $array['SUB_SYSTEM_ID'] ?></div>
		<div class="hiddenData KINO_ID"><?php echo $array['KINO_ID'] ?></div>
	</div>
<?php $count++; ?>
<?php endforeach; ?>	
</div>

...
<?php foreach ($lsts as $array): ?>
	<div class="tableRow row_dat" style="width:1230px;">
		...
		<div class="tableCell cell_dat cd" style="width:200px;"><?php echo $array['NINUSI_CD'] ?></div>
		<div class="tableCell cell_dat nm" style="width:600px;"><?php echo $array['NINUSI_NM'] ?></div>
		<div class="tableCell cell_dat nm" style="width:250px;"><?php echo $array['NINUSI_RYAKU'] ?></div>

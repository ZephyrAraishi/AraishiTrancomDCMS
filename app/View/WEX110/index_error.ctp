...
?>
	<div class="tableRow row_dat" style="width:1540px;">
		...
		<div class="tableCell cell_dat KBN" style="width:80px;"><?php echo $cellsArray[1] ?></div>
		<div class="tableCell cell_dat KBN" style="width:80px;"><?php echo $cellsArray[2] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[3] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[4] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[5] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[6] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[7] ?></div>
		<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[8] ?></div>
		<div class="tableCell cell_dat kin" style="width:100px;"><?php echo $cellsArray[9] ?></div>
		<div class="tableCell cell_dat kin" style="width:100px;"><?php echo $cellsArray[10] ?></div>
		<div class="tableCell cell_dat kin" style="width:100px;"><?php echo $cellsArray[11] ?></div>

<?php
			echo $this->Html->script(array('effects','window','protocalendar','base64',
					...
					,'DCMSHRD010_K_UPDATE','DCMSHRD010_S_CALENDAR'), array('inline'=>false));
...
<div id="wrapper_s">
	...
	<ul id="hrd_nav">
		...
		<li><a class="active" href="#">基本</a></li>
	...
	<div style="position:relative;height:270px;margin-top:20px;text-align:left;">
		...
		<div style="position:absolute;height:25px;top:30px;left:200px;width:140px;">
			<input type="text" style="width:140px;height:20px;" id="staff_nm" name="staff_nm" maxlength="30" value="<?php echo $staff["STAFF_NM"] ?>">
		</div>
		...
		<div style="position:absolute;height:25px;top:60px;left:200px;width:140px;">
			<input type="text" style="width:140px;height:20px;" id="password" name="password" class="han" maxlength="30" value="<?php echo $staff["PASSWORD"] ?>">
		</div>
		...
		<div style="position:absolute;height:25px;top:90px;left:200px;width:140px;">
			<input type="text" style="width:140px;height:20px;" id="ic_no" name="ic_no" class="han" maxlength="16" value="<?php echo $staff["IC_NO"] ?>">
		</div>
		...
		<div style="position:absolute;height:25px;top:120px;left:200px;width:140px;">
			<select id="kbn_sex" name="kbn_sex">
				<option value="" <?php if($staff["KBN_SEX"] == "") echo "selected" ?> ></option>
<?php
		foreach($kbn_sex as $array) {
?>
				<option value="<?php echo $array["MEI_CD"] ?>" <?php if($staff["KBN_SEX"] == $array["MEI_CD"]) echo "selected" ?> ><?php echo $array["MEI_1"] ?></option>
<?php
		}
?>
			</select>
		...
		<div style="position:absolute;height:25px;top:150px;left:200px;width:140px;">
			<input type="text" style="width:140px;height:20px;" id="ymd_birth" name="ymd_birth" class="han" maxlength="8" value="<?php
		if($staff["YMD_BIRTH"] != "") {
			echo str_replace("-","",$staff["YMD_BIRTH"]);
		}
?>" >
		</div>
		...
		<div style="position:absolute;height:25px;top:180px;left:200px;width:140px;">
			<select id="haken_kaisya_cd" name="haken_kaisya_cd">
				<option value=""  <?php if($staff["HAKEN_KAISYA_CD"] == "") echo "selected" ?>></option>
<?php
		foreach($haken_kaisya_cd as $array) {
?>
				<option value="<?php echo $array["KAISYA_CD"] ?>" <?php if($staff["HAKEN_KAISYA_CD"] == $array["KAISYA_CD"]) echo "selected" ?> ><?php echo $array["KAISYA_NM"] ?></option>
<?php
		}
?>
			</select>
		...
		<div style="position:absolute;height:260px;top:0px;left:440px;width:360px;text-align:center;border:1px solid lightGray;">
			...
			<form enctype="multipart/form-data" action="/DCMS/HRD010/image_upload" method="POST" target="temp">
				<div id="uplist" style="margin-top:15px;">
					<img src="<?php if($image["PHOTO_IMG"] != "") echo "data:image/png;base64," . $image["PHOTO_IMG"] ; else echo "/DCMS/img/no-image.gif";?>" id="upload-image"><br>
				</div>
...
<?php
		...
		foreach($kyoten as $array) {
			...
			if ($staff["DAI_NINUSI_CD"] == $array["NINUSI_CD"] &&
				$staff["DAI_SOSIKI_CD"] == $array["SOSIKI_CD"]) {
				$checked1 = "checked";
			}

			$checked2 = '';

			foreach($kyoka_kyoten as $obj) {

				if ($obj["NINUSI_CD"] == $array["NINUSI_CD"] &&
					$obj["SOSIKI_CD"] == $array["SOSIKI_CD"]) {
...
?>
		<div class="tableRow row_dat" style="height:26px;width:780px;margin-left:1px;">
			<div class="tableCell cell_dat" style="width:70px;height:22px;padding-top:3px;" >
				<input class="daihyo" type="radio" name="daihyo" <?php echo $checked1; ?>>
			</div>
			<div class="tableCell cell_dat" style="width:70px;height:22px;padding-top:3px;" >
				<input class="kanoKyoten" type="checkbox" <?php echo $checked2; ?>></div>
	...
	<div style="position:relative;height:60px;margin-top:20px;text-align:left;">
		...
		<div style="position:absolute;height:25px;top:00px;left:200px;width:140px;">
			<select id="kbn_pst" name="kbn_pst">
				<option value="" <?php if($staff["KBN_PST"] == "") echo "selected" ?>></option>
<?php
		foreach($kbn_pst as $array) {
?>
				<option value="<?php echo $array["MEI_CD"] ?>" <?php if($staff["KBN_PST"] == $array["MEI_CD"]) echo "selected" ?>><?php echo $array["MEI_1"] ?></option>
<?php
		}
?>
			</select>
		...
		<div style="position:absolute;height:25px;top:30px;left:200px;width:140px;">
			<select id="kbn_keiyaku" name="kbn_keiyaku">
				<option value="" <?php if($staff["KBN_KEIYAKU"] == "") echo "selected" ?>></option>
<?php
		foreach($kbn_keiyaku as $array) {
?>
				<option value="<?php echo $array["MEI_CD"] ?>" <?php if($staff["KBN_KEIYAKU"] == $array["MEI_CD"]) echo "selected" ?>><?php echo $array["MEI_1"] ?></option>
<?php
		}
?>
			</select>
		...
		<div style="position:absolute;height:25px;top:00px;left:540px;width:140px;">
			<select id="kbn_pick" name="kbn_pick">
				<option value="" <?php if($staff["KBN_PICK"] == "") echo "selected" ?>></option>
<?php
		foreach($kbn_pick as $array) {
?>
				<option value="<?php echo $array["MEI_CD"] ?>" <?php if($staff["KBN_PICK"] == $array["MEI_CD"]) echo "selected" ?>><?php echo $array["MEI_1"] ?></option>
<?php
		}
?>
			</select>
...
<?php
		...
		foreach($zone as $array) {
			...
			foreach($yusen_zone as $obj) {

				if ($obj["ZONE"] == $array["MEI_CD"]) {
	...
	<div style="position:relative;height:120px;margin-top:20px;text-align:left;">
		...
		<div style="position:absolute;height:25px;top:00px;left:200px;width:140px;">
			<select id="rank" name="rank">
				<option value="" <?php if($staff["RANK"] == "") echo "selected" ?>></option>
<?php
		foreach($rank as $array) {
?>
				<option value="<?php echo $array["RANK"] ?>" <?php if($staff["RANK"] == $array["RANK"]) echo "selected" ?>><?php echo $array["RANK"] ?></option>
<?php
		}
?>
			</select>
		...
		<div style="position:absolute;height:25px;top:30px;left:200px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="kin_syotei" name="kin_syotei" class="han" maxlength="12" value="<?php echo $staff["KIN_SYOTEI"] ?>">　円
		</div>
		<div style="position:absolute;height:25px;top:60px;left:40px;width:120px;margin-top:2px;">時間外</div>
		<div style="position:absolute;height:25px;top:60px;left:200px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="kin_jikangai" name="kin_jikangai" class="han" maxlength="12" value="<?php echo $staff["KIN_JIKANGAI"] ?>">　円
		</div>
		<div style="position:absolute;height:25px;top:90px;left:40px;width:120px;margin-top:2px;">深夜時間</div>
		<div style="position:absolute;height:25px;top:90px;left:200px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="kin_sny" name="kin_sny" class="han" maxlength="12" value="<?php echo $staff["KIN_SNY"] ?>">　円
		</div>
		...
		<div style="position:absolute;height:25px;top:30px;left:540px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="kin_kst" name="kin_kst" class="han" maxlength="12" value="<?php echo $staff["KIN_KST"] ?>">　円
		</div>
		...
		<div style="position:absolute;height:25px;top:60px;left:540px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="kin_h_kst" name="kin_h_kst" class="han" maxlength="12" value="<?php echo $staff["KIN_H_KST"] ?>">　円
		</div>
		...
		<div style="position:absolute;height:25px;top:90px;left:540px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="kin_h_kst_sny" name="kin_h_kst_sny" class="han" maxlength="12" value="<?php echo $staff["KIN_H_KST_SNY"] ?>">　円
		</div>
	</div>
	...
	<div style="position:relative;margin-top:30px;margin-left:40px;">
		<div class="tableRowTitle row_ttl_1" style="height:26px;width:709px;margin-left:1px;">
			<div class="tableCell cell_ttl_1" style="width:70px;height:22px;padding-top:3px;" >曜日</div>
			<div class="tableCell cell_ttl_1" style="width:90px;height:22px;padding-top:3px;" >出社</div>
			<div class="tableCell cell_ttl_1" style="width:90px;height:22px;padding-top:3px;" >退社</div>
			<div class="tableCell cell_ttl_1" style="width:419px;height:22px;padding-top:3px;" >備考</div>
		</div>
...
value="<?php
		if($staff["SUN_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["SUN_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["SUN_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["SUN_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="sun_biko" name="sun_biko" maxlength="30" value="<?php echo $staff["SUN_BIKO"] ?>">
			</div>
		</div>
		<div class="tableRow row_dat" style="height:32px;width:709px;margin-left:1px;">
...
value="<?php
		if($staff["MON_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["MON_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["MON_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["MON_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="mon_biko" name="mon_biko" maxlength="30" value="<?php echo $staff["MON_BIKO"] ?>">
			</div>
		</div>
		<div class="tableRow row_dat" style="height:32px;width:709px;margin-left:1px;">
...
value="<?php
		if($staff["TUE_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["TUE_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["TUE_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["TUE_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="tue_biko" name="tue_biko" maxlength="30" value="<?php echo $staff["TUE_BIKO"] ?>">
			</div>
		</div>
		<div class="tableRow row_dat" style="height:32px;width:709px;margin-left:1px;">
...
value="<?php
		if($staff["WED_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["WED_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["WED_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["WED_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="wed_biko" name="wed_biko" maxlength="30" value="<?php echo $staff["WED_BIKO"] ?>">
			</div>
		</div>
		<div class="tableRow row_dat" style="height:32px;width:709px;margin-left:1px;">
...
value="<?php
		if($staff["THU_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["THU_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["THU_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["THU_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="thu_biko" name="thu_biko" maxlength="30" value="<?php echo $staff["THU_BIKO"] ?>">
			</div>
		</div>
		<div class="tableRow row_dat" style="height:32px;width:709px;margin-left:1px;">
...
value="<?php
		if($staff["FRI_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["FRI_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["FRI_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["FRI_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="fri_biko" name="fri_biko" maxlength="30" value="<?php echo $staff["FRI_BIKO"] ?>">
			</div>
		</div>
		<div class="tableRow row_dat" style="height:32px;width:709px;margin-left:1px;">
...
value="<?php
		if($staff["SAT_TIME_ST"] != "") {
			echo substr(str_replace(":","",$staff["SAT_TIME_ST"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:90px;height:28px;padding-top:3px;" >
...
value="<?php
		if($staff["SAT_TIME_ED"] != "") {
			echo substr(str_replace(":","",$staff["SAT_TIME_ED"]),0,4);
		}
?>" >
			</div>
			<div class="tableCell cell_dat" style="width:419px;height:28px;padding-top:3px;" >
				<input type="text" style="width:400px;height:20px;" id="sat_biko" name="sat_biko" maxlength="30" value="<?php echo $staff["SAT_BIKO"] ?>">
			</div>
		</div>
	</div>
	<div style="position:relative;height:90px;margin-top:20px;text-align:left;">
		...
		<div style="position:absolute;height:25px;top:00px;left:200px;width:140px;">
			<input type="text" style="width:140px;height:20px;" id="ymd_syugyo_st" name="ymd_syugyo_st" class="han" maxlength="8" value="<?php
		if($staff["YMD_SYUGYO_ST"] != "") {
			echo str_replace("-","",$staff["YMD_SYUGYO_ST"]);
		}
?>" >
		</div>
		<div style="position:absolute;height:25px;top:30px;left:40px;width:120px;margin-top:2px;">就業終了日</div>
		<div style="position:absolute;height:25px;top:30px;left:200px;width:140px;">
			<input type="text" style="width:140px;height:20px;" id="ymd_syugyo_ed" name="ymd_syugyo_ed" class="han" maxlength="8" value="<?php
		if($staff["YMD_SYUGYO_ED"] != "") {
			echo str_replace("-","",$staff["YMD_SYUGYO_ED"]);
		}
?>" >
		</div>
		<div style="position:absolute;height:25px;top:60px;left:40px;width:120px;margin-top:2px;">出勤日数上限</div>
		<div style="position:absolute;height:25px;top:60px;left:200px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="syukin_nisu_max" name="syukin_nisu_max" class="han" maxlength="2" value="<?php echo $staff["SYUKIN_NISU_MAX"] ?>">　日
		</div>
		...
		<div style="position:absolute;height:25px;top:0px;left:560px;width:160px;">
			<input type="text" style="width:110px;height:20px;" id="syukin_time_max" name="syukin_time_max" class="han" maxlength="4" value="<?php echo $staff["SYUKIN_TIME_MAX"] ?>">　時間
		</div>
		...
		<div style="position:absolute;height:25px;top:30px;left:560px;width:140px;">
			<input type="text" style="width:110px;height:20px;" id="chingin_max" name="chingin_max" class="han"  maxlength="12" value="<?php echo $staff["CHINGIN_MAX"] ?>">　円
		</div>
	</div>
	...
	<div style="position:relative;height:180px;margin-top:20px;text-align:left;">
		<div style="position:absolute;height:180px;top:0px;left:40px;width:700px;margin-top:2px;">
			<textarea style="width:700px;height:150px;resize: none;" id="tuiki_jiko"  maxlength="3000"><?php echo $staff["TUIKI_JIKO"] ?></textarea>
		</div>
	</div>
	<div style="position:relative;height:50px;margin-left:40px;margin-top:20px;" >
		<div style="position:absolute;height:30px;top:0px;left:0px;width:200px;margin-top:2px;text-align:left;">
			<select id="del_flg" name="del_flg">
				<option value="0" <?php if($staff["DEL_FLG"] == "" || $staff["DEL_FLG"] == "0") echo "selected" ?>>このスタッフコードはシステム使用可能</option>
				<option value="1" <?php if($staff["DEL_FLG"] == "1") echo "selected" ?>>このスタッフコードはシステム使用不可</option>
			</select>
		</div>
		<div style="position:absolute;height:30px;top:0px;left:540px;width:150px;margin-top:2px;text-align:right;">

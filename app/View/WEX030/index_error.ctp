...
?>
	<div class="tableRow row_dat" style="width:1230px;">
			...
			<div class="tableCell cell_dat nm" style="width:150px;"><?php echo $cellsArray[2] ?></div>
			<div class="tableCell cell_dat nm" style="width:415px;"><?php echo $cellsArray[3] ?></div>
 			<div class="tableCell cell_dat kbn" style="width:85px;"><?php echo $cellsArray[4] ?></div>
			<div class="tableCell cell_dat kbn" style="width:50px;"><?php echo $cellsArray[5] ?></div>

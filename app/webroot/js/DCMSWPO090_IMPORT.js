...
function clickImportButton(event) {
    ...
    new Ajax.Request( actionUrl2, {
	  ...
	  onFailure : function( event )  {
	    location.href = "/DCMS/WPO090/index?return_cd=91&message=" + Base64.encode(DCMSMessage.format("CMNE000103"));
	  },
	  onException : function( event, ex )  {
	    location.href = "/DCMS/WPO090/index?return_cd=92&message=" + Base64.encode(DCMSMessage.format("CMNE000104"));
	  }
	});
}
...
function onSuccessEvent2(res) {
	...
	location.href = "/DCMS/WPO090/index?" + result + "&display=true";

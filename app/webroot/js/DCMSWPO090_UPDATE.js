...
function clickUpdateButton(event) {
    ...
    new Ajax.Request( actionUrl3, {
	  ...
	  onFailure : function( event )  {
	    location.href = "/DCMS/WPO090/index?return_cd=91&message=" + DCMSMessage.format("CMNE000103");
	  },
	  onException : function( event, ex )  {
	    location.href = "/DCMS/WPO090/index?return_cd=92&message=" + DCMSMessage.format("CMNE000104");
	  }
	});
}

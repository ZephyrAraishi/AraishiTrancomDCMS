...
InputMonthCalendar.createOnLoaded('period_from', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymm'});
InputMonthCalendar.createOnLoaded('period_to', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymm'});

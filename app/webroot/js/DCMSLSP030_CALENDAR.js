...
InputCalendar.createOnLoaded('startYmd', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymmdd'});
InputCalendar.createOnLoaded('endYmd', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymmdd'});

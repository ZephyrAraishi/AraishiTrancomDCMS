...
InputCalendar.createOnLoaded('startYmdInsText', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymmdd'});
InputCalendar.createOnLoaded('endYmdInsText', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymmdd'});

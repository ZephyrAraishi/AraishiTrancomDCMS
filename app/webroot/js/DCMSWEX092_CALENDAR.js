...
InputMonthCalendar.createOnLoaded('startYm', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymm'});
InputMonthCalendar.createOnLoaded('endYm', {inputReadOnly: false,lang:'ja', weekFirstDay:ProtoCalendar.SUNDAY, format: 'yyyymm'});

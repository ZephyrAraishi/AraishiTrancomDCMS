...
function clickUploadButton(event) {
    ...
    new Ajax.Request( actionUrl, {
	  ...
	  onFailure : function( event )  {
	    location.href = "/DCMS/HRD010/shinki?return_cd=91&message=" + Base64.encode(DCMSMessage.format("CMNE000103"));
	  },
	  onException : function( event, ex )  {
	    location.href = "/DCMS/HRD010/shinki?return_cd=92&message=" + Base64.encode(DCMSMessage.format("CMNE000104"));
	  }
	});
}
...
function onSuccessEvent(res) {
	...
	//ロケーションの変更
	location.href = "/DCMS/HRD010/shinki?" + result + "&display=true";
}
